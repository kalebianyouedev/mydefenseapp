...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> _openWithdrawSheet(WalletSummary summary) async {
    final requested = await showModalBottomSheet<bool>(
      ...
      builder: (_) => _WithdrawSheet(organisation: widget.organisation, summary: summary),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Portefeuille', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w700, color: authInk)),
      ),
      body: SafeArea(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          TextButton(
                            onPressed: _refresh,
                            child: Text('Réessayer', style: GoogleFonts.poppins(fontSize: 12.5, fontWeight: FontWeight.w700, color: authPrimary)),
                          ),
                        ],
                      ),
                    ),
          ...
          Column(
            ...
            children: [
              Text('+${fmt.format(transaction.grossAmount)} XAF',
                  style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w700, color: authInk)),
              const SizedBox(height: 2),
              Text('dont ${fmt.format(transaction.netAmount)} XAF net',
                  style: GoogleFonts.poppins(fontSize: 10.5, color: authMuted)),
            ],
          ),
        ],
      ),
...
class _BalanceCard extends StatelessWidget {
        ...
        children: [
          Row(
            children: [
              ...
              Text(organisation.name,
                  ...
                  style: GoogleFonts.poppins(fontSize: 12.5, fontWeight: FontWeight.w600, color: Colors.white70)),
            ],
          ),
          const SizedBox(height: 14),
          Text('Solde disponible', style: GoogleFonts.poppins(fontSize: 12.5, color: Colors.white70)),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text('Demander un retrait', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700)),
  ...
  Widget _statRow(String label, String value) {
    return Row(
      children: [
        Expanded(child: Text(label, style: GoogleFonts.poppins(fontSize: 12, color: Colors.white70))),
        Text(value, style: GoogleFonts.poppins(fontSize: 12.5, fontWeight: FontWeight.w700, color: Colors.white)),
      ],
    );
  }
}
...
class _WithdrawSheetState extends State<_WithdrawSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (!mounted) return;
      showAuthSnack(context, 'Demande de retrait envoyée.');
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 18),
          Text('Demander un retrait', style: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.w700, color: authInk)),
          const SizedBox(height: 4),
          ...
          Text('Montant (XAF)', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600, color: authInk)),
          const SizedBox(height: 8),
          TextField(
          ...
          const SizedBox(height: 18),
          Text('Moyen de réception', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600, color: authInk)),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _submitting
                  ...
                  : Text('Envoyer la demande', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ),
...
class _WithdrawalTile extends StatelessWidget {
  ...
  static const _labels = {
    ...
    WithdrawalStatus.rejected: 'Refusé',
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('${fmt.format(withdrawal.amount)} XAF',
                    style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700, color: authInk)),
                const SizedBox(height: 2),
                Text(
                  '${paymentMethodLabel(withdrawal.paymentMethod)} · ${withdrawal.phone}'
                  '${withdrawal.createdAt != null ? ' · ${dateFmt.format(withdrawal.createdAt!)}' : ''}',
                  style: GoogleFonts.poppins(fontSize: 11.5, color: authMuted),
                ),
              ],
            ),
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Text(_labels[withdrawal.status]!,
              ...
              if (withdrawal.status == WithdrawalStatus.pending) ...[
                ...
                GestureDetector(
                  ...
                  child: Text('Annuler', style: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.w600, color: authPrimary)),
                ),
              ],
            ],
          ),
