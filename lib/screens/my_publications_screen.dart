    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Mes publications', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w700, color: authInk)),
          bottom: TabBar(
            labelColor: authPrimary,
            unselectedLabelColor: authMuted,
            indicatorColor: authPrimary,
            labelStyle: GoogleFonts.poppins(fontSize: 13.5, fontWeight: FontWeight.w600),
            unselectedLabelStyle: GoogleFonts.poppins(fontSize: 13.5, fontWeight: FontWeight.w500),
            tabs: const [
              Tab(text: 'Événements'),
              Tab(text: 'Votes'),
            ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(title, style: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.w700, color: authInk)),
            const SizedBox(height: 6),
            Text(message, textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 13, color: authMuted)),
            const SizedBox(height: 8),
            Text('Utilisez le bouton "Posts" pour en créer un.',
                textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 12, color: authMuted)),
          ],
        ),
      ),
    );
